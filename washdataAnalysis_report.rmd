...
print(ggplot(n_intv_hh, aes(x = n))
	+ geom_histogram(binwidth = 1)
	+ stat_bin(binwidth = 1, geom="text", color='white'
		, aes(label = paste0(percent(..count../sum(..count..))))
...
print(ggplot(n_intv_year, aes(x = year, y = n))
	+ geom_bar(stat='identity')
	+ geom_text(aes(label=paste0(percent(n/sum(n))))
		, stat='identity'
